...
func (m *mgo) FindOne(key string, value interface{}) *mongo.SingleResult {
	collection, _ := Mongo.Database(m.db).Collection(m.col).Clone()
	//col.
...
func (m *mgo) InsertOne(value interface{}) *mongo.InsertOneResult {
	collection := Mongo.Database(m.db).Collection(m.col)
...
func (m *mgo) FindAndUpdate(filter interface{}, update interface{}) *mongo.SingleResult {
	return Mongo.Database(m.db).Collection(m.col).FindOneAndUpdate(context.TODO(), m.filter, m.update)
}

func (m *mgo) UpdateOne(filter interface{}, update interface{}) (*mongo.UpdateResult, error) {
	return Mongo.Database(m.db).Collection(m.col).UpdateOne(context.TODO(), m.filter, m.update)
}

func (m *mgo) UpdateMany(filter interface{}, update interface{}) (*mongo.UpdateResult, error) {
	return Mongo.Database(m.db).Collection(m.col).UpdateMany(context.TODO(), m.filter, m.update)
}
